...
const configuredBase =`r`n  process.env.NEXT_PUBLIC_API_URL ||`r`n  (process.env.NODE_ENV === "production"`r`n    ? "https://rsre-backend.onrender.com/api"`r`n    : "http://localhost:8000/api");
