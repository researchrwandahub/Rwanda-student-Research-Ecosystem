  ...
  return <header className="border-b border-slate-200/80 bg-white/95 backdrop-blur-xl">
    ...
    <div className="rsre-page flex min-h-[76px] items-center justify-between gap-4 py-3">
      <Link href="/" className="flex items-center gap-3">
        ...
        <div className="hidden sm:block"><div className="text-sm font-black text-slate-950">RSRE</div><div className="text-[11px] text-slate-500">Research Support and Research Ecosystem</div></div>
      </Link>
