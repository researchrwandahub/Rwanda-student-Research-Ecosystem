    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="rsjh-page relative py-20 md:py-28">
          <p className="rsjh-eyebrow text-emerald-300">ABOUT RSJH</p>
        ...
        <div className="rsjh-page grid gap-8 lg:grid-cols-[1.2fr_.8fr] items-start">
          <div className="rsjh-card p-8 md:p-10">
            ...
            <div className="mt-6 space-y-5 text-slate-600 leading-8">
              <p>RSJH was created around a practical problem: health students can be surrounded by research questions but still struggle to find a clear route from an idea to credible evidence and publication.</p>
              ...
              <p>MedTech Rwanda provides the digital infrastructure behind the platform, while RSJH is designed as a scholarly community that can grow across Rwanda's health-science institutions.</p>
            </div>
          </div>
