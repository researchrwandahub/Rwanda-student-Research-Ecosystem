  ...
  return <Layout><main>
    <section className="relative overflow-hidden bg-[#06182b] text-white">
      ...
      <div className="relative rsre-page grid gap-10 py-18 md:grid-cols-[1.15fr_.85fr] md:py-24 md:items-center">
        <div><div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-emerald-200"><Sparkles size={14}/> Research Support and Research Ecosystem (RSRE)</div><h1 className="mt-7 text-5xl font-black leading-[1.02] tracking-tight md:text-7xl">From curiosity to credible research.</h1><p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">A research ecosystem for learners, students and researchers to learn, discover, build projects, collaborate and publish through RSJH.</p><div className="mt-9 flex flex-wrap gap-3"><Link href="/auth/register" className="inline-flex items-center gap-2 rounded-2xl bg-emerald-500 px-6 py-3.5 text-sm font-black text-slate-950">Start your research journey <ArrowRight size={17}/></Link><Link href="/articles" className="inline-flex items-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-6 py-3.5 text-sm font-black text-white"><BookOpen size={17}/> Explore RSJH Journal</Link></div></div>
